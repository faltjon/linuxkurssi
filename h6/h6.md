...
Seuraavaksi lisäsin settings.py tiedostoon 'crm'


![alt text](https://github.com/faltjon/linuxkurssi/blob/main/h6/kuvat/17-settings.png " ")¨

Sitten loin models kautta uuden customers-taulun ja siihen nimi-sarakkeen `micro jonico/settings.py`
...
Seruaavaksi rekisteröin tietokannan admin.py tiedostossa `micro crm/admin.py`
